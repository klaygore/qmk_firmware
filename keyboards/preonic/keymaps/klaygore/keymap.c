...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_WSCH,        TT(6),   KC_LALT, KC_LGUI, LT(6,KC_BSPC), LOWER,   RAISE,   LT(6,KC_SPC),  KC_RCTL, KC_LEFT, KC_RGHT, KC_DOWN  \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  QWERTY,  COLEMAK, DVORAK,  _______, _______, _______, _______, _______, _______,  _______, _______, RESET,  \
...
[_NUMPAD] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, KC_DEL,  _______, _______, KC_P0,   KC_PDOT, KC_EQL,  KC_PPLS, _______  \
)
