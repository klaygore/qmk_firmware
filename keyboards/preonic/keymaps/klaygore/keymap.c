...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_WSCH,        MO(3),      KC_LALT, KC_LGUI, LT(_BSPMOD,KC_BSPC), LOWER,   RAISE,   LT(_SPMOD,KC_SPC),  KC_RCTL, KC_HOME, KC_END,  KC_PGDN  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_UP  , _______, KC_PAUS, _______,  \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,  KC_MUTE, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
),
...
[_BSPMOD] = LAYOUT_preonic_grid( \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  \
  _______, _______, _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   _______, KC_NLCK,  \
  _______, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, _______, _______, KC_P4,   KC_P5,   KC_P6,   _______, KC_CALC, \
  _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_NO,   _______, _______  \
),
...
[_SPMOD] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_MINS, KC_PLUS, KC_UNDS, KC_EQL , _______, \
