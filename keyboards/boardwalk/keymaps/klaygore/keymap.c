 ...
 */
 ...
 [_MAIN] = LAYOUT_ortho_5x14(
  ...
  KC_WSCH,        LCTL(KC_F), KC_LALT, KC_LGUI, LT(4,KC_BSPC), TT(2),   KC_PGDN,  TT(3), LT(4,KC_SPC),  RUN_CMD,   KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT\
 ),
 ...
 */
 ...
 [_RAISE] = LAYOUT_ortho_5x14(
  ...
  KC_VOLD, RUN_CTP, _______, _______, _______, MO(5),   _______, _______, _______, RUN_CPM, _______, _______, _______, _______ \
 ),
 ...
 */
 ...
 [_NUMPAD] = LAYOUT_ortho_5x14(
  _______, _______, _______, _______, _______, _______, _______, _______, KC_PSLS,  KC_PAST,   KC_PMNS, KC_PPLS, _______, _______,   \
  KC_CALC, _______, _______, _______, _______, _______, _______, _______, KC_P7,    KC_P8,     KC_P9,   _______, _______, KC_NLCK, \
  ...
  _______, _______, _______, _______, KC_DEL,  _______, _______, _______, KC_P0,    KC_PDOT,   KC_PENT, _______, _______, _______ \
 ),
