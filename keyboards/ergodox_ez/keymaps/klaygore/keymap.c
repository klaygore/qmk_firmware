...
[BASE] = LAYOUT_ergodox(
  ...
  KC_LCTL,        KC_Z,          KC_X,    KC_C,    KC_V,    KC_B,    RUN_CTP,
  RUN_RDP,        LCTL(KC_F),    KC_LALT, KC_LGUI, LT(NUML,KC_BSPC),
                                                                      KC_HOME,  KC_END,
                                                                                KC_PGUP,
  ...
  LT(NUML,KC_SPC),  KC_NO,   KC_RGUI, KC_WSCH, RUN_CMD,
  KC_LEFT, KC_RIGHT,
  KC_UP,
...
[SYMB] = LAYOUT_ergodox(
  ...
  _______, _______, _______, _______, _______, _______, KC_F6,
  ...
  _______, KC_MINS, KC_PLUS, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______,
  _______, _______,
  _______,
...
[SYMB2] = LAYOUT_ergodox(
  // left hand
  _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, KC_F18,
  _______, KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,
  _______, KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,
  _______, _______, _______, _______, _______,
                                               _______, _______,
                                                        _______,
                                      _______, _______, _______,
  ...
  _______, KC_UNDS, KC_EQL,  _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______,
  _______, _______,
  _______,
