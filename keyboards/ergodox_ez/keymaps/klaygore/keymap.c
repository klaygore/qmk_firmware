 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  ESC   |   1  |   2  |   3  |   4  |   5  |CTLGUI|           | `~   |   6  |   7  |   8  |   9  |   0  |  DEL   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | SFTTAB |   Q  |   W  |   E  |   R  |   T  | CAPS |           | NUM  |   Y  |   U  |   I  |   O  |   P  |  SFT \ |
 * |--------+------+------+------+------+------| LOCK |           | LOCK |------+------+------+------+------+--------|
 * | ENTER  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |  ;:  |  '"    |
 * |--------+------+------+------+------+------| CTL  |           | MEH  |------+------+------+------+------+--------|
 * | LCTRL  |   Z  |   X  |   C  |   V  |   B  | SFT  |           |      |   N  |   M  |   ,  |   .  |  /   |  RCTRL |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |SFTGUI| FIND | Alt  | LGUI |BSPACE|                                       |SPACE |CTLALT| RGUI |SEARCH|ALTSFT|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,------------.
 *                                        | HOME | END  |       | LEFT |RIGHT|
 *                                 ,------|------|------|       |------+-----+------.
...
[BASE] = LAYOUT_ergodox(
  // left hand
  KC_ESC,         KC_1,          KC_2,    KC_3,    KC_4,    KC_5,    LCTL(LGUI(KC_NO)),
  LSFT_T(KC_TAB), KC_Q,          KC_W,    KC_E,    KC_R,    KC_T,    KC_CAPS,
  KC_ENT,         KC_A,          KC_S,    KC_D,    KC_F,    KC_G,
  KC_LCTL,        KC_Z,          KC_X,    KC_C,    KC_V,    KC_B,    C(S(KC_NO)),
  SGUI(KC_NO),    LCTL(KC_F),    KC_LALT, KC_LGUI, LT(NUML,KC_BSPC),
                                                                      KC_HOME,  KC_END,
                                                                                KC_PGUP,
  ...
  MEH(KC_NO),       KC_N,        KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
  LT(SPMOD,KC_SPC), LCA(KC_NO),  KC_RGUI, KC_WSCH, A(S(KC_NO)),
  KC_LEFT, KC_RIGHT,
  KC_UP,
