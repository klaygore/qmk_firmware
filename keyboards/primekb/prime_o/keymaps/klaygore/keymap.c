 ...
 */
  ...
  [0] = LAYOUT(
    ...
    KC_DEL,  	    LCTL(KC_F), KC_LALT, KC_LGUI, LT(5,KC_BSPC), TT(2),  TT(3), LT(4,KC_SPC), KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN,          KC_RIGHT, KC_P0,    KC_PDOT,     KC_PENT
  ),
 ...
 */
    ...
    _______,  _______,  _______,  _______,  _______, MO(6),    _______,  _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______
  ),
