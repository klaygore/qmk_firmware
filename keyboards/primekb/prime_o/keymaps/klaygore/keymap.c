 ...
 */
  ...
  [0] = LAYOUT(
    ...
    KC_DEL,  	    LCTL(KC_F), KC_LALT, KC_LGUI, LT(5,KC_BSPC), TT(2),  TT(3), LT(5,KC_SPC), KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN,          KC_RIGHT, KC_P0,    KC_PDOT,     KC_PENT
  ),
 ...
 */
  ...
  [1] = LAYOUT(
    ...
    KC_DEL,         TD(TRI_P),  KC_LALT,  KC_LSFT,  KC_BSPC, TT(2),   TT(3),     KC_SPC,  KC_RCTL,  LCA(KC_F),  KC_LEFT,   KC_DOWN,         KC_RIGHT,   KC_P0,     KC_PDOT,     TD(ENT_EQL)
  ),
 ...
 */
    ...
    _______,  _______,  _______,  _______,  _______, MO(4),    _______,  _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______
  ),
 ...
 */
    ...
    _______,  _______,  _______,  _______,  KC_DEL,   _______,  _______,  KC_P0,     KC_PDOT,   KC_PENT,  KC_PPLS,  _______,  _______,  _______,  _______,  _______
  ),
