 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | ` ~  |      |      |      |BSpace|LOWER |RAISE |Space | RCTL |      | Left | Down | Right|  0   |  .   |  =   |
 * |      |      |  Alt | GUI  |      |      |      |      |      |      |      |      |      |INSERT| DEL  |      |
 * `---------------------------------------------------------------------------------------------------------------'
 */
  ...
  [WOW] = LAYOUT(
    ...
    KC_GRV,         MO(WOWMACROS), KC_LALT,  KC_LGUI,  KC_BSPC, TT(LOWER), TT(RAISE), KC_SPC,  KC_RCTL,  KC_LGUI,          KC_LEFT,   KC_DOWN,         KC_RIGHT,   KC_P0,     KC_PDOT,     KC_PEQL
  ),
