 ...
 */
 ...
 LAYOUT TERMINOLOGY
 --------------------------------------------------
 ISO 				- split left shift
 ANSI 				- big left shift
 
 split/left/right 	- refers to the spacebar
 
 PANDA 				- full 1u in the numpad area
 num 				- 2u key in far bottom right
 --------------------------------------------------
 */
 
 /*PANDA_layout is a layout using full 1u keys in the numpad area.*/
 
#define PANDA_iso_split( \
