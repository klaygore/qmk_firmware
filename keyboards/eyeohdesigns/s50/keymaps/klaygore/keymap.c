...
KC_MPLY,                                               	                                                              
  ...
  _______,                                                                                                                                 
     ...
     *      `------------------------------------------------------------------------------'
     */
			LSFT_T(KC_ESC), _______, _______, _______, _______, _______, _______, KC_7, KC_8, KC_9, _______, KC_BSLS, _______, _______,  
  _______,                                                                                                                                 
	              		 _______, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, _______, _______, KC_4, KC_5, KC_6, _______, _______, _______, _______,  
			_______, _______, _______, _______, _______, _______, _______, _______, KC_1, KC_2, KC_3, _______, _______, BL_INC, _______, 
			_______, _______, _______, _______,  	 _______, 		    KC_0, 	KC_PDOT,  _______, BL_TOGG, BL_DEC, BL_BRTG
),
     ...
     *      `----------------------------------------------------------------------------'
     */
				LSFT_T(KC_ESC), KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_GRV , _______, _______,  
  _______,                                                                                                                                 
	              		 _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_MINS, KC_PLUS, KC_UNDS, KC_EQL, _______, _______, _______,  
