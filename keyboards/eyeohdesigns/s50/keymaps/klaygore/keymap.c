...
KC_MUTE,                                               	                                                              
  ...
  _______,                                                                                                                                 
     ...
     *      `------------------------------------------------------------------------------'
     */
				 BL_TOGG, _______, _______, _______, _______, _______, _______, KC_7, KC_8, KC_9, _______, KC_BSLS, _______, _______,  
  _______,                                                                                                                                 
			...
			_______, _______, _______, _______,  	 _______, 		    KC_0, 	KC_PDOT,  _______, _______, BL_DEC, BL_BRTG
),
